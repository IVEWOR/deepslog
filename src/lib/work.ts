...
export const featuredProjects: WorkCard[] = [
  {
    title: "Footwear Brand Acquisition",
    year: "2026",
    description:
...
export const additionalProjects: WorkCard[] = [
  {
...
export const workProjects: WorkCard[] = [...featuredProjects, ...additionalProjects];

export const featuredSlugs: string[] = featuredProjects.map((p) => p.link);
