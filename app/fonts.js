...
export const ppNeueMontreal = localFont({
  src: [
    ...
    { path: "../public/fonts/PPNeueMontreal-ExtraboldItalic.woff2", weight: "800", style: "italic" },
  ],
  display: "swap",
...
export const ppNeueMontrealText = localFont({
  src: [
    ...
    { path: "../public/fonts/PPNeueMontrealText-BookItalic.woff2", weight: "400", style: "italic" },
  ],
  display: "swap",
