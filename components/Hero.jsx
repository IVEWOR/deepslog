  ...
  return (
    <section className="relative pt-28 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
        ...
        <div className="flex-3 text-center lg:text-left flex flex-col w-full">
          {/* 1. TEXT SECTION (order-1) */}
          <div className="order-1">
            <h1 className="animate-fade-in-up [animation-delay:100ms] text-[38px] sm:text-5xl lg:text-7xl font-extrabold text-slate-900 tracking-tight mb-6 leading-[1.1]">
              I engineer <br className="hidden lg:block" />
            ...
            <p className="animate-fade-in-up [animation-delay:250ms] text-lg lg:text-xl text-slate-600 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Full-stack development specializing in speed, scalability, and
              conversions for ambitious brands and agencies.
            </p>

            <div className="animate-fade-in-up [animation-delay:400ms] flex items-center justify-center lg:justify-start gap-3 mb-10 text-sm font-medium text-slate-500 flex-wrap">
              ...
              <span>•</span>
              <span>React, Next.js, Node, Shopify</span>
            </div>
          </div>
