    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        {features.map((feature, index) => (
          <div
            key={feature.number}
            className={`animate-fade-in-up border-[color:var(--color-border-light)] px-[clamp(1.5rem,4vw,4rem)] py-10 lg:py-14 ${
          ...
          >
            ...
            <p className="body-sm mt-3 max-w-sm text-[color:var(--color-muted)]">
              {feature.description}
            </p>
          </div>
        ))}
